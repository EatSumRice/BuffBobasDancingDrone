...
(cl:defmethod cl:initialize-instance :after ((m <Song>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Song)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name buff_boba_pkg-msg:<Song> is deprecated: use buff_boba_pkg-msg:Song instead.")))

(cl:ensure-generic-function 'filename-val :lambda-list '(m))
(cl:defmethod filename-val ((m <Song>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader buff_boba_pkg-msg:filename-val is deprecated.  Use buff_boba_pkg-msg:filename instead.")
  (filename m))

(cl:ensure-generic-function 'tempo-val :lambda-list '(m))
(cl:defmethod tempo-val ((m <Song>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader buff_boba_pkg-msg:tempo-val is deprecated.  Use buff_boba_pkg-msg:tempo instead.")
  (tempo m))

(cl:ensure-generic-function 'time_sig-val :lambda-list '(m))
(cl:defmethod time_sig-val ((m <Song>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader buff_boba_pkg-msg:time_sig-val is deprecated.  Use buff_boba_pkg-msg:time_sig instead.")
  (time_sig m))

(cl:ensure-generic-function 'pickup-val :lambda-list '(m))
(cl:defmethod pickup-val ((m <Song>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader buff_boba_pkg-msg:pickup-val is deprecated.  Use buff_boba_pkg-msg:pickup instead.")
  (pickup m))

(cl:ensure-generic-function 'beat_durations-val :lambda-list '(m))
(cl:defmethod beat_durations-val ((m <Song>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader buff_boba_pkg-msg:beat_durations-val is deprecated.  Use buff_boba_pkg-msg:beat_durations instead.")
  (beat_durations m))
